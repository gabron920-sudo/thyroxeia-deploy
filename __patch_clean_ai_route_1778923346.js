...
${cards}`
  ...
  const requestedModel = body.model || c.env.GEMINI_MODEL || 'gemini-2.0-flash'
  const modelCandidates = [...new Set([requestedModel, 'gemini-2.0-flash', 'gemini-2.5-flash', 'gemini-flash-latest'].filter(Boolean))]
